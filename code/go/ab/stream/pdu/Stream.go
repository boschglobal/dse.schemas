...
func (rcv *Stream) SimulationTime() float64 {
...
/// Metadata: Simulation Time when this stream was produced.
func (rcv *Stream) MutateSimulationTime(n float64) bool {
...
func StreamAddSimulationTime(builder *flatbuffers.Builder, simulationTime float64) {
	builder.PrependFloat64Slot(2, simulationTime, 0.0)
}
