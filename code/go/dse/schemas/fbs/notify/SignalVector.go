...
func FinishSignalVectorBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedSignalVectorBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
